...
export declare function createPlayerService(context: PlayerContext, { getCastFn, applyEventsAsynchronously, emitter }: PlayerAssets): StateMachine.Service<PlayerContext, PlayerEvent, PlayerState>;
